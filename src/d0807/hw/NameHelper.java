...
public class NameHelper {
    ...
    public static String createName(String xing, boolean isMan) {
        ...
        if (isMan) {
            //男性
            int i = r.nextInt(MAN_XINGS.length);
            ming = MAN_XINGS[i];
        } else {
            int i = r.nextInt(WOMAN_XINGS.length);
            ming = WOMAN_XINGS[i];
        }
        return xing + ming;
    }
    ...
    public static String createName() {
        return createName(r.nextBoolean());
    }
     ...
     * @return
     */
    public static String createName(String xing, boolean isMan, byte number) throws Exception {
        if (number > 3) {
            throw new NameException("名字长度超过3");
        }
        StringBuilder sb = new StringBuilder();
        for (int i = 0; i < number; i++) {
            if (isMan) {
                int a = r.nextInt(MAN_STRING.length());
                char c = MAN_STRING.charAt(a);
                sb.append(c);
            } else {
                int a = r.nextInt(WOMAN_STRING.length());
                char c = WOMAN_STRING.charAt(a);
                sb.append(c);
            }
        }
    ...
    public static void main(String[] args) {
        System.out.println(createName("钟", true));
        System.out.println(createName("钟", true));
        System.out.println(createName("钟", false));
        System.out.println(createName("钟", false));

        System.out.println(createName("文", true));
        System.out.println(createName("文", true));
        System.out.println(createName("文", false));
        System.out.println(createName("文", false));
        ...
        try {
            System.out.println(createName("钟", true, (byte) 1));
            System.out.println(createName("钟", true, (byte) 2));
            System.out.println(createName("钟", true, (byte) 3));
            System.out.println(createName("尉迟", false, (byte) 1));
            System.out.println(createName("尉迟", false, (byte) 2));
            System.out.println(createName("尉迟", false, (byte) 3));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
